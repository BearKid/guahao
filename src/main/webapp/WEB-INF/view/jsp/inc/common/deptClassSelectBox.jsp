...
<script>
    ...
    //选择某个一级科室
    $("#deptClassesPanel #firstDeptClassesPanel button").click(function () {
        var $province = $(this);
    ...
    //选择某个二级科室
    $("#deptClassesPanel #secondDeptClassesPanel").find("button").click(function () {
        var $this = $(this);
    ...
    //切换回一级科室导航标签
    $("#deptClassesPanel #firstDeptClassNavTag").click(function () {
    ...
    //取消并关闭选择城市侧边栏
    $("#deptClassesPanel #jsCancelDeptClassesPanel").click(function () {
        $("#deptClassesPanel").hide();
        $("#screenMask").hide();
        $("#firstDeptClassNavTag").trigger("click");
    });
    //确认已选择的城市并关闭侧边栏
    $("#deptClassesPanel #jsOkDeptClassesPanel").click(function () {
        var areaCode = $(this).data("areaCode");
        if (areaCode) {
            var $inputDeptClassCode = $("#inputDeptClassCode");
            ...
            $inputDeptClassCode.trigger("change");
        } else {
            alert("未选择二级科室");
        }
    });
    //选择空选项并关闭侧边栏
    $("#deptClassesPanel #jsSelectEmptyOption").click(function(){
